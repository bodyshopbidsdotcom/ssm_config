require './lib/ssm_test/ssm_storage/db.rb'
require './lib/ssm_test/ssm_storage/yml.rb'
require './lib/ssm_test/ssm_storage/empty.rb'
require 'active_support/core_ext/hash/indifferent_access'
require 'active_support/time'
require './lib/ssm_test/errors.rb'
...
class SsmConfig
  ...
  class << self
    ...
    def determine_query(meth)
      query_database = SsmTest::SsmStorage::Db.new(meth)
      query_yml = SsmTest::SsmStorage::Yml.new(meth)
    ...
    def write_config_accessor_for(meth)
      self.instance_eval %{
      def #{meth}(obj = SsmTest::SsmStorage::Empty.new)
